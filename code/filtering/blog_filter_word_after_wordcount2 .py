...
# 시작 디렉터리를 설정합니다.
start_dir = os.path.join(current_dir, 'data', 'wordcount2','mangwon')
...
for dirpath, dirnames, filenames in os.walk(start_dir):
    for filename in filenames:
        ...
        try:
            ...
            ,'하나','가지','곧','사람','사장','방문','도','의','를','은','트','빈','교','고','완','과'
            ...
            output_directory = os.path.join(current_dir, 'data', 'filtering','blog_reviews2','mangwon')
            output_filename = os.path.join(output_directory, os.path.basename(dirpath).replace('.txt', '_filtered2.csv'))
